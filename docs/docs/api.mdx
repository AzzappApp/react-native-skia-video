...
| `encoderMode` | `'copy' \| 'direct'?` | `copy` | iOS, experimental: `direct` hands rendered frames to the encoder through one GPU copy, asynchronously (see [exporting](/docs/video-composition/exporting)). |
